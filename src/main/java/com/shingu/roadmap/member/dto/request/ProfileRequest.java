...
public record ProfileRequest(
        ...
        @Schema(description = "희망 직무 코드", example = "[84, 85]", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
        @Size(max = 10, message = "희망 직무는 최대 10개까지 선택 가능합니다")
        Set<Integer> desiredJobCodes,

        @Schema(description = "현재 직업", example = "학생", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
