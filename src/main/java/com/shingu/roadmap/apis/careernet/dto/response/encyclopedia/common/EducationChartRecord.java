...
public record EducationChartRecord(
        @JsonProperty("chart_name") @Schema(description = "학력분포명") String chartName, // chart_name 필드 추가
        @JsonProperty("chart_data") @Schema(description = "학력분포 데이터") String chartData, // Integer -> String
