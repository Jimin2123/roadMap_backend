...
public record BaseInfoRecord(
        ...
        @JsonProperty("emp_job_cd") @Schema(description = "고용코드") String empJobCd, // Integer -> String
        @JsonProperty("job_cd") @Schema(description = "직업코드") Integer jobCd,
        @JsonProperty("satisfication") @Schema(description = "직업만족도") Double satisfication, // Integer -> Double
        ...
        @JsonProperty("wage") @Schema(description = "평균연봉") String wage, // Integer -> String
        @JsonProperty("seq") @Schema(description = "직업 일련번호") Integer seq // seq 필드 추가
) {}